...
(printf "====================================================\n")
(printf "      newLISP Transpiled & Compiled Test Suite      \n")
(printf "====================================================\n\n")

;; 1. Literal and Reader Syntax
(check-nl "Integer addition" "(+ 1 2 3 4 5)" "15")
(check-nl "Hexadecimal literal" "0xFF" "255")
...
(check-nl "Float literal" "3.1415" "3.1415")
(check-nl "Quoted string with escapes" "\"hello\\nworld\"" "\"hello\\nworld\"")
(check-nl "Decimal ASCII escape in string" "\"\\065BC\"" "\"ABC\"")
(check-nl "Hex ASCII escape in string" "\"\\x41BC\"" "\"ABC\"")
(check-nl "Curly brace string" "{line 1\nline 2}" "\"line 1\\nline 2\"")
...
(check-nl "Commas in parameter lists"
          "(begin (define (add3 a , b , c) (+ a b c)) (add3 10 20 30))"
          "60")
...
(check-nl "dolist loop"
          "(begin (set 'res '()) (dolist (x '(10 20 30)) (push (* x 2) res -1)) res)"
          "(20 40 60)")
...
(check-nl "catch and throw"
          "(catch (begin (throw 42) 99))"
          "42")
(check-nl "catch error capture"
          "(begin (catch (/ 1 0) 'err) (if err true nil))"
          "true")

;; 14. List Manipulation Builtins
...
(check-nl "assoc and lookup"
          "(begin (set 'al '((a 1) (b 2))) (list (assoc 'b al) (lookup 'a al)))"
          "((b 2) 1)")

;; 15. Strings and Regex
...
(check-nl "starts-with and ends-with"
          "(list (starts-with \"hello world\" \"hello\") (ends-with \"filename.lsp\" \".lsp\"))"
          "(true true)")

;; 16. Arrays & Matrices
(check-nl "array creation and array-list"
          "(array-list (array 3 '(1 2 3)))"
          "(1 2 3)")
